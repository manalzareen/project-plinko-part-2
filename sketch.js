...
function draw() {
 ...
 // division2.display(); 
  ...
  //division4.display();
 // division5.display();
  //division6.display();  textSize(20)
 text("Score : "+score,20,30);
 textSize(20);
 fill("red");
 text("50"+score,30,410);
 text("50"+score,120,410);
 text("40"+score,200,410);
 text("40"+score,290,410);
 text("30"+score,380,410);
 text("30"+score,470,410);
 if (particle = null){
  particle.display();
